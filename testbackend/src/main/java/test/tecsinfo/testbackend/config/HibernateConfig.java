package test.tecsinfo.testbackend.config;
...
@Configuration
@ComponentScan(basePackages={"test.tecsinfo.testbackend.dto"})
...
public class HibernateConfig {
	...
	private final static String DATABASE_PASSWORD = "postgresql";
	...
	public SessionFactory getSessionFactory(DataSource dataSource){
		...
		builder.scanPackages("test.tecsinfo.testbackend.dto");
